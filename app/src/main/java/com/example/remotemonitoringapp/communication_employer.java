...
public class communication_employer extends AppCompatActivity {
        ...
        create_comment_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!messageText.equals("") && !EmployeeEmail.equals("") && !EmployeeName.equals("") && !EmployeeDepartment.equals("") && !company_id.equals("")){
                    ...
                    Toast.makeText(communication_employer.this, "No field should be empty", Toast.LENGTH_LONG).show();
    ...
    public void addMessageBox(String message,String sender_text, int type){
        TextView textView = new TextView(communication_employer.this);
        textView.setText(message);

        TextView textView2 = new TextView(communication_employer.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(communication_employer.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                            }
