...
public class update_aob_employee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(update_aob_employee.this,
        ...
        delete_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(update_aob_employee.this);
    ...
    public void update_aob() {
        ...
        if (!STRING_EMPTY.equals(aob_title.getText().toString())) {
            ...
            Toast.makeText(update_aob_employee.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //Toast.makeText(update_aob_employee.this, response, Toast.LENGTH_LONG).show();
                            ...
                            if (success == 1) {
                                Toast.makeText(update_aob_employee.this, "AOB updated", Toast.LENGTH_LONG).show();
                                load_dashboard();
                            } else {
                                Toast.makeText(update_aob_employee.this, "Failed to update AOB.", Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if((jsonObject.get("success").toString()).equals("1")) {
                                Toast.makeText(update_aob_employee.this, jsonObject.get("message").toString(), Toast.LENGTH_LONG).show();

                                Intent i = new Intent(update_aob_employee.this, aob_employee.class);
                                startActivity(i);
