    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     public void load_recycler(String json) throws JSONException
     {
         ...
         for(int i=0; i<jsonArray.length();i++) {
             ...
             list.add(new taskData("Task :"+jObject.getString("task"),"Deadline: "+jObject.getString("deadline"),
                     ...
                     public void onResponse(String response) {
                         ...
                         try {
                             ...
                             if (success == 1) {
                                 ...
                                 Toast.makeText(Task.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                             }
