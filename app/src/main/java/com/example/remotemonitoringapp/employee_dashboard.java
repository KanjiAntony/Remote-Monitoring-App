...
public class employee_dashboard extends AppCompatActivity {
    ...
    private String KEY_MANAGER_LOGGED = "LoggedStat";
    private String PREF_MANAGER_NAME = "Pop-InSession";
    private static final String KEY_MANAGER_USER_ID = "UserId";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences spManager = getSharedPreferences(PREF_MANAGER_NAME, Context.MODE_PRIVATE);
        ...
        Reports.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), reports_employee.class);
                startActivity(i);
                finish();
        ...
        logout_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(session.isEventLoggedIn()) {
                    session.logout_events();
                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(employee_dashboard.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                            }
