 ...
 public class aob_employee extends AppCompatActivity {

     aobEmployeeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       getSupportActionBar().setTitle("AOB");
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(aob_employee.this, upload_aob_employee.class);
     ...
     public void load_recycler(String json) throws JSONException
     {
         ...
         adapter = new aobEmployeeAdapter(list, getApplication());
         recyclerView.setAdapter(adapter);
         recyclerView.setLayoutManager(new LinearLayoutManager(aob_employee.this));
                     ...
                     public void onResponse(String response) {
                         ...
                         try {
                             ...
                             if (success == 1) {
                                 ...
                                 Toast.makeText(aob_employee.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                             }
