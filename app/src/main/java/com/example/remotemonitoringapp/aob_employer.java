 ...
 public class aob_employer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       getSupportActionBar().setTitle("AOB");
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(aob_employer.this, upload_aob_employer.class);
     ...
     public void load_recycler(String json) throws JSONException
     {
         ...
         adapter = new aobAdapter(list, getApplication());
         recyclerView.setAdapter(adapter);
         recyclerView.setLayoutManager(new LinearLayoutManager(aob_employer.this));
                     ...
                     public void onResponse(String response) {
                         ...
                         try {
                             ...
                             if (success == 1) {
                                 ...
                                 Toast.makeText(aob_employer.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                             }
