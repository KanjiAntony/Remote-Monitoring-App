...
public class communication_employee extends AppCompatActivity {
    ...
    private String EmployeeEmail,EmployeeName,EmployeeDepartment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference1 = new Firebase("https://remoteapp-ae875-default-rtdb.firebaseio.com/messages/Remote_AppComm");
        ...
        create_comment_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!messageText.equals("") && !EmployeeEmail.equals("") && !EmployeeName.equals("") && !EmployeeDepartment.equals("") && !company_id.equals("")){
                    Map<String, String> map = new HashMap<String, String>();
                    map.put("message", messageText);
                    map.put("user", active_user_id);
                    map.put("user_email", EmployeeEmail);
                    map.put("user_name", EmployeeName);
                    map.put("user_department", EmployeeDepartment);
                    map.put("company_id", company_id);
                    reference1.push().setValue(map);
                    commentTxt.setText("");
                } else {

                    Toast.makeText(communication_employee.this, "No field should be empty", Toast.LENGTH_LONG).show();

                }
            }
        });

        reference1.orderByChild("company_id").equalTo(company_id).addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                String userDept = map.get("user_department").toString();

                if(userId.equals(active_user_id)){
                    addMessageBox(message,"", 1);
                }
                else{
                    addMessageBox(message,"Sent by: "+userName+" from ("+userDept+")", 2);
                }
            }
    ...
    public void addMessageBox(String message,String sender_text, int type){
        TextView textView = new TextView(communication_employee.this);
        textView.setText(message);

        TextView textView2 = new TextView(communication_employee.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                EmployeeDepartment = jsonObject.getString("employee_department");
                                //company_id = jsonObject.getString("company_id");
                            } else {
                                Toast.makeText(communication_employee.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                            }
