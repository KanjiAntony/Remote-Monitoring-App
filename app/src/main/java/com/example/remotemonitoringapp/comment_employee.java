...
public class comment_employee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comment_employee);
    ...
    public void addMessageBox(String message,String sender_text, int type){
        TextView textView = new TextView(comment_employee.this);
        textView.setText(message);

        TextView textView2 = new TextView(comment_employee.this);
