...
public class founderLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_button = (Button) findViewById(R.id.companyLoginBtn);
        ...
        register_page.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(founderLogin.this,
    ...
    public void login() {
        ...
        if (!STRING_EMPTY.equals(email_address.getText().toString()) && !STRING_EMPTY.equals(user_password.getText().toString())) {
            ...
            Toast.makeText(founderLogin.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
    ...
    public void volleyJsonObjectRequest(String url) {
        ...
        String REQUEST_TAG = "founderLogin";
        ...
        StringRequest jsonObjectReq = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(founderLogin.this, response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(founderLogin.this, "Failed to log you in.", Toast.LENGTH_LONG).show();
                            }
